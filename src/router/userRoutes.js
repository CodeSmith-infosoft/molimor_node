...
router.put('/updateProfile', validateAccessToken, saveUserProfile, updateProfile); // user
router.put('/changePassword', validateAccessToken, changePassword); // user
router.post('/forgetEmail', forgetEmail); // forget password email
router.post('/resetPassword', resetPassword); // forget password email
...
router.put('/updateUserById/:id', validateAccessToken, authorizeRoles('admin'), saveUserProfile, updateUserById); // admin
router.put('/inActiveUserById/:id', validateAccessToken, authorizeRoles('admin'), inActiveUserById); // admin
...
router.post('/admin/addEmailShopNowButton', aboutusImage, validateAccessToken, authorizeRoles('admin'), addEmailShopNowButton); // admin add  url using email send 
router.get('/getEmailShopNowButton', getEmailShopNowButton); // using email send 

router.post('/admin/addsubscribeEmailTemp', aboutusImage, validateAccessToken, authorizeRoles('admin'), addsubscribeEmailTemp); // admin add  url using email send 

router.get('/admin/downloadSubscribedUsersCSV', aboutusImage, validateAccessToken, authorizeRoles('admin'), downloadSubscribedUsersCSV);
router.get('/admin/downloadUsersCSV', aboutusImage, validateAccessToken, authorizeRoles('admin'), downloadUsersCSV);
