...
const orderSchema = new Schema({
  ...
  couponId: { type: Schema.Types.ObjectId, ref: 'coupons', required: false },
...
const orderValidation = Joi.object({
  ...
  couponId: Joi.string().optional().messages({
    'string.base': 'couponId must be a string',
  }),
  ...
  shippingCity: Joi.string().optional().messages({
    'string.base': 'shippingCity must be a string',
  }),
  ...
  city: Joi.string().min(1).required().messages({
    ...
    'string.min': 'city must be at least 1 characters',
